...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\markdown on
     Windows, /home/user/dev/markdown on Linux) in a file named
     markdown@jason.smith and copy that file to
